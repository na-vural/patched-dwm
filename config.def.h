...
static const char *colors[][3]      = {
	...
	[SchemeUrg]  =  { col_white, col_red,    col_red },
};
...
#define TAGKEYS(KEY,TAG) \
	...
	{ KeyPress,     MODKEY|Mod1Mask,              KEY,      tagnextmon,     {.ui = 1 << TAG} }, \
	{ KeyPress,     MODKEY|Mod1Mask|ShiftMask,    KEY,      tagprevmon,     {.ui = 1 << TAG} },
...
static const Key keys[] = {
	...
	TAGKEYS(        XK_8,                         7)
	TAGKEYS(        XK_9,                         8)
	{ KeyPress,     MODKEY|ShiftMask,             XK_q,      quitprompt,           {0} },
};
